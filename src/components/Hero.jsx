    ...
    <header className='w-full flex justify-center items-center flex-col'>
        <nav className='flex justify-between items-center w-full p-4'>
            <a href='#' className='flex'>
                <img src="public/favicon.ico" alt="App Logo" className='h-8 object-contain'/>
        ...
        <h1 className='mt-5 text-5xl font-extrabold leading-[1.15] text-black sm:text-6xl text-center'>Summarize Articles with <br className='max-md:hidden'/>
